...
const AboutMe = {
	role: "Web developer" ,
	code: ["☕Java", "🌐HTML", "🎨CSS", "🗄️SQL PL/SQL", "🐚Bash", "🔧Git"],
	tools:["🌱Spring", "🐬MySQL", "🍃 MariaDB", "🎀 SASS", "☁️AWS", "🐳Docker"]
};
```
##  💻 Technology
...
<div align="center"> 
<img src="https://denvercoder1-github-readme-stats.vercel.app/api/top-langs/?username=shengye472&langs_count=8&layout=compact&theme=react&hide_border=true&bg_color=#1A3AB7&title_color=FFFFFF&icon_color=FFFFFF&hide=Jupyter%20Notebook,Roff"%20height="213px">
</div>
